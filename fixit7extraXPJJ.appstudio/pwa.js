...
const cacheName = 'fixit7extraXPJJ-2020-10-04 21:51:54.633392'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'fixit7extraXPJJ'.length) === 'fixit7extraXPJJ') {
